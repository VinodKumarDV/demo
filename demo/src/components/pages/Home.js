 ...
 return (
  <>
   <Box textAlign="center" className={classes.headingColor} p={1} mb={2}>
    <Typography variant="h2">Record api</Typography>
   </Box>
   <Grid container justify="center" spacing={4}>
    <Grid item md={6} xs={12}>
     ...
     <form noValidate>
      ...
      <Box m={3}>
       <Button type="submit" variant="contained" color="primary" fullWidth onClick={e => onFormSubmit(e)}>Add new record</Button>
      </Box>
     </form>
    </Grid>
